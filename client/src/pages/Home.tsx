...
export default function Home() {
  ...
  return <main className="architect-plan"><div className="plan-layout">
    ...
    <section className="plan-intro"><div><p className="drawing-label">01 / INFORMATION ARCHITECTURE</p><h2>A minimal plan for the proposed public site.</h2></div><div className="plan-notes"><p>Each plotted point is a page or flow. Select a point to inspect a simple template mockup.</p><p><b>Priority:</b> Opening a fund · Multi-fund giving · Mobile checkout</p></div></section>
